...
const ProductsComp = () => {
    ...
    return (
        <div style={{backgroundColor:'#D1E9F6',minHeight:"100vh"}}>
            ...
            <main>
                <h3 className='display-3' style={{ color: '#F72C5B', fontSize: '40px', marginBottom: '20px', marginLeft:'25px'}}>Products</h3>
                <div className='row mb-2 mx-2'>
                    <div className='col-xl-4 col-lg-4 col-md-12 mb-2 text-md-center col-sm-12 text-sm-center text-center'>
                        <div className='card' style={{width:'300px',height:'300px',justifySelf:'center'}}>
                ...
                <Link to={"/addcomp"} className='btn btn-primary btn-sm add'>
                    <AddIcon/>Add
                </Link>
